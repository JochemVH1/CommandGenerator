...
Public Class CommandGenerator
    ...
    Private _commandDefintion As CommandDefinition

    Public Sub New(commandDefinition As CommandDefinition)
        ...
        For Each commandField In _commandDefintion.CommandFields
            ...
            Else 
                ...
                If Not codeTypeReference Is Nothing
                    codeSnippet = New CodeSnippetTypeMember() With {
                        .Text = "Property " + commandField.Name + " As " + codeTypeReference.ToString()       
                        }
                    targetClass.Members.Add(codeSnippet)
                End If
            End If
